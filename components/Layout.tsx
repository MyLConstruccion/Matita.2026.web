...
const Layout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-matita">
      {/* Carrusel Superior Profesional */}
        ...
        <div className="container mx-auto px-6 flex flex-col items-center gap-8">
          <div className="flex items-center justify-between w-full">
             <NavLink to="/" className="flex items-center gap-6 group">
                <div className="w-24 h-24 md:w-32 md:h-32 bg-[#fadb31] rounded-full flex items-center justify-center shadow-2xl transition-all duration-700 group-hover:rotate-12 border-4 border-white">
             ...
             <div className="flex items-center gap-6">
                <div className="hidden md:flex items-center gap-8">
                   ...
                   <Cart />
                   <button onClick={handleLogout} className="px-10 py-3 matita-gradient-pink text-white rounded-full text-2xl shadow-xl hover:scale-110 font-bold">Salir</button>
                </div>
  ...
  {navItems.map((item) => (
    ...
    >
      ...
      <footer className="bg-[#fadb31]/10 border-t-[10px] border-[#fadb31]/40 py-24 relative overflow-hidden">
        <div className="absolute top-0 left-10 text-[10rem] opacity-5 rotate-12">✏️</div>
        <div className="absolute bottom-10 right-10 text-[10rem] opacity-5 -rotate-12">🎨</div>
        ...
        <div className="container mx-auto px-8 flex flex-col items-center text-center space-y-16">
           ...
           <div className="flex flex-col md:flex-row gap-16 text-3xl text-gray-500">
           ...
           <p className="text-lg text-gray-400 opacity-60 italic">© 2024 Matita Librería • La Calera, CBA</p>
        </div>
      </footer>
    </div>
  );
